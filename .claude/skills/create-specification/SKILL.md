...
description: Generate or update specification documents for new or existing functionality. Use when the user asks to write a spec, draft requirements, document an interface or data contract, or update files in /spec/. Produces AI-ready, structured Markdown specs following a fixed template.
---
...
**Source:** Adapted from [`github/awesome-copilot`](https://github.com/github/awesome-copilot/blob/main/agents/specification.agent.md) (`agents/specification.agent.md`).
