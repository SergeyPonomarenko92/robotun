...
import {
  ...
  mediaKycRetentionSweep,
  mediaSoftDeleteGraceSweep,
  mediaHardDeletedRowPurge,
  outboxRetention,
  listingDraftExpiry,
  sessionsPurge,
...
export const adminRoutes: FastifyPluginAsync = async (server) => {
  ...
  const JOBS: Record<string, () => Promise<number>> = {
    ...
    kyc_pre_expiry_warn: kycPreExpiryWarn,
    kyc_user_soft_delete_consumer: kycUserSoftDeleteConsumer,
    kyc_annual_rekyc: kycAnnualRekyc,
    listing_draft_auto_archive: listingDraftAutoArchive,
    listings_kyc_revoked_consumer: listingsKycRevokedConsumer,
    listings_category_archived_consumer: listingsCategoryArchivedConsumer,
    listings_provider_status_consumer: listingsProviderStatusConsumer,
    listings_role_revoked_consumer: listingsRoleRevokedConsumer,
    media_kyc_retention_sweep: mediaKycRetentionSweep,
    media_soft_delete_grace_sweep: mediaSoftDeleteGraceSweep,
    media_hard_deleted_row_purge: mediaHardDeletedRowPurge,
